...
import { Package, MapPin, Bitcoin, Eye, RefreshCw, Briefcase } from 'lucide-react';
import Link from 'next/link';
import { getPackages, pickupPackage, deletePackage, getEffectiveStatus, getJobs, applyForJob } from '@/lib/nostr';
...
export default function ViewPackages() {
  ...
  const isOwnPackage = (pkg: any) => {
    return pkg.pubkey === useNostr().publicKey;
  };

  const isOwnJob = (job: any) => {
    return job.pubkey === useNostr().publicKey;
  };
